...
import com.ranganayaki.jetpackapps.databinding.ActivityDbDemoBinding
...
class DbDemoActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding: ActivityDbDemoBinding = DataBindingUtil.setContentView(this, R.layout.activity_db_demo)
