package com.ranganayaki.androidbasics
...
class ChatActivity : AppCompatActivity() {
    ...
    private fun leftRightChatBubbles()  {
        ...
        vwRt.findViewById<TextView>(R.id.txRtMsg).text = " WhatsApp Messenger, or simply WhatsApp, is an American freeware, cross-platform centralized instant messaging (IM) and voice-over-IP (VoIP) service owned by Facebook, Inc.[12] It allows users to send text messages and voice messages,[13] make voice and video c "
